...
//            DispatchQueue.main.async {
            if success {
                ...
                let alert = UIAlertController(title: "Log In Error",
                        message: "We were unable to log in you",
...
//            }
    ...
    @objc private func didTapPrivacyButton() {
        guard let url = URL(string: "https://help.instagram.com/519522125107875/?helpref=hc_fnav&bc[0]=Instagram%20Help&bc[1]=Privacy%20and%20Safety%20Center") else {
            return
        }
        let vc = SFSafariViewController(url: url)
        present(vc, animated: true)
